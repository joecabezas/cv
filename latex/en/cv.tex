    ...
    \resumeSubheading
      ...
      {Senior Software Engineer}{Oct 2024 \textbf{--} Present}
        \resumeItemListStart
            ...
            \resumeItem{Improved prduct usability by leading a refactor to unify product navigation to be role-based, which involved both backend and frontend changes}
            \resumeItem{Led the efforts to diagnose and optimize performance bottlenecks in critical API endpoints, reducing response latency for lager customers}
