...
\section{Work Experience}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Senior Software Engineer}{Oct 2024 \textbf{--} Present}
        \resumeItemListStart
            \resumeItem{Contributed to functionality to support Rippling's complex customer segments, such as developing benefits logic for companies with multiple legal entities or custom insurance plan}
            \resumeItem{Improved product usability by leading a refactor to unify product navigation to be role-based, which involved both backend and frontend changes}
            \resumeItem{Led the efforts to diagnose and optimize performance bottlenecks in critical API endpoints, reducing response latency for large customers}
            \resumeItem{Built internal tooling enhancements, including company enrollments timeline visibility to improve overall operational troubleshooting and support workflows}
            \resumeItem{Represented ERx team during security reviews}
            \resumeItem{Technologies used: Python, Django, MongoDB, Typescript, Node.js, ReactJS, Docker}
        \resumeItemListEnd
    % \vspace{15pt}
    \resumeSubheading
      {Gusto}{San Francisco, CA}
      {Senior Software Engineer}{Sep 2023 \textbf{--} Oct 2024}
        \resumeItemListStart
    ...
    \resumeSubheading
      ...
      {Senior Software Engineer, Software Engineer}{Aug 2018 \textbf{--} Sep 2023}
        \resumeItemListStart
            ...
            \resumeItem{Designed and developed a domain-specific language (DSL) named \emph{JsonLisp}, which enables customers to formulate rules using modern programming language features and is JSON compatible, which empowered Checkr Assess customers to create highly intricate rules}
...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
      ...
      \begin{itemize}
        \vspace{-5pt}
        \item[] \textbf{Backend:}\hspace{3pt}{Ruby on Rails, Node.js, Django, Apache Kafka, Sidekiq, HAML, CakePHP, CodeIgniter}
      ...
      \resumeProjectHeading
        {\textbf{JsFormat} $|$ \emph{\href{https://github.com/jdavisclark/JsFormat/pull/24}{\color{blue}github.com/jdavisclark/JsFormat/pull/24}}}{}
          \resumeItemListStart
            ...
            \resumeItem{I created a new option I needed to allow spaces before line starters and make it the default option for backward compatibility}
          \resumeItemListEnd
      ...
      \resumeProjectHeading
        {\textbf{ESP8266 VU Meter} $|$ \emph{\href{https://github.com/joecabezas/esp8266\_vu\_meter}{\color{blue}github.com/joecabezas/esp8266\_vu\_meter}}}{}
          \resumeItemListStart
            ...
            \resumeItem{The server is a single device with a single MEMS microphone (sph0645) and a esp8266 microcontroller, it broadcasts volume data collected in realtime via UDP packets to all listeners clients in order for all clients to display the same data regardless of the distance of the sound source}
