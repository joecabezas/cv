    ...
    \resumeSubheading
      ...
      {Software Development Engineer}{Mar 2015 \textbf{--} Aug 2018}
        \resumeItemListStart
            ...
            \resumeItem{Created a framework for continuous deployment for AWS Lambdas using multiple accounts for different deployment stages}
        \resumeItemListEnd
    \resumeSubheading
      ...
      {Software Development Engineer}{Sep 2011 \textbf{--} Jan 2015}
        \resumeItemListStart
            ...
            \resumeItem{\textbf{iBlast Moki 2} $|$ Game Port from iOS to android using the Mobage Platform ins Javascript, implementation of the physics engine}
        \resumeItemListEnd
